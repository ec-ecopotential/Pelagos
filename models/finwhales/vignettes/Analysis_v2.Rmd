...
[x] 1. get occurrences
[] 2. get environmental data from FTP (chlo) + Copernicus (sst) + Bathymetry (sdmpredictors BO_bathymean) for each yearmonth that we have whale data for
...
# filter too old
occ <- occ[occ$yearcollected >= 1998,]
# get environment
...
background[,"yearcollected"] <- occ[occdateindex,"yearcollected"]
